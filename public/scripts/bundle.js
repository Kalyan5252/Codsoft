...
var hideAlert = exports.hideAlert = function hideAlert() {
  var el = document.querySelector(".login__status");
  if (el) el.parentElement.removeChild(el);
};
var showAlert = exports.showAlert = function showAlert(type, mesg) {
  hideAlert();
  // const markup = `<div class="alert alert--${type}">${mesg}</div>`;
  var alertmesg = "<div class=\"login__status\">\n    <h3 class=\"login_status-text ".concat(type, "\">").concat(mesg, "</h3>\n  </div>");
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('login_success', 'Logged in successfully!');
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('login_failure', _context.t0.response.data.message);
        case 11:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          res = _context3.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('login_success', 'Account created successfully!');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"userSettings.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateProfile = exports.makeReivew = exports.makePurchase = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('login_success', 'Profile updated Successfully');
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('login_failure', err.response.data.message);
        case 11:
        case "end":
          return _context.stop();
      }
...
var makeReivew = exports.makeReivew = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          _context2.prev = 8;
          _context2.t0 = _context2["catch"](0);
          (0, _alerts.showAlert)('login_failure', _context2.t0.response.data.message);
        case 11:
        case "end":
          return _context2.stop();
      }
  ...
  return function makeReivew(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
var makePurchase = exports.makePurchase = /*#__PURE__*/function () {
  ...
  return function makePurchase(_x3) {
    return _ref3.apply(this, arguments);
  };
}();
...
var buyProduct = document.querySelectorAll('.book-product');
var userDataForm = document.querySelector('.form_user');
var logoutBtn = document.querySelector('.logout');
var signupForm = document.querySelector('.signup__form');
var productBuy = document.querySelector('.details');
var reviewForm = document.querySelector('.newRatingSec');
...
if (buyProduct) {
  buyProduct.forEach(function (ele) {
    if (ele) {
      ele.addEventListener('click', function (e) {
        ...
        // );
        (0, _userSettings.makePurchase)(productId);
      });
    }
  });
}
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    (0, _userSettings.updateProfile)(form, 'data');
  });
}
if (logoutBtn) {
...
if (reviewForm) {
  ...
  reviewForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var review = document.getElementById('review_context').value;
    // console.log({ rating, review });
    var slug = location.href.split('/');
    slug = slug[slug.length - 1];
    (0, _userSettings.makeReivew)({
      rating: rating,
      review: review,
      slug: slug
    });
...
},{"./login":"login.js","./userSettings":"userSettings.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
